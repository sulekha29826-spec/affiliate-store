  ...
  return (
    <div className="bg-white border border-[#E0E0E0] rounded-[2px] p-3 sm:p-4 my-3 max-w-7xl mx-auto shadow-xs">
      ...
      <div className="flex items-center justify-between pb-3 mb-3 border-b border-[#F0F0F0]">
        <div>
          <h2 className="text-base sm:text-xl font-bold text-[#212121] leading-tight">
            {title}
          </h2>
          {subtitle && (
        ...
        {viewAllLink && (
          <Link
            to={viewAllLink}
            className="bg-[#2874F0] hover:bg-blue-700 text-white text-xs font-semibold px-3 py-1.5 rounded-[2px] flex items-center gap-1 shadow-xs transition-colors shrink-0"
          >
            <span>VIEW ALL</span>
